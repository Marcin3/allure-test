...
public class SearchPO {
	...
	public SearchPO(ITestContext context) {
		...
		DesiredCapabilities desiredCapabilities = (DesiredCapabilities) context.getAttribute("desiredCapabilities");
		System.out.println(desiredCapabilities.getVersion());
		System.out.println(desiredCapabilities.getCapability("appPackage"));
	}
